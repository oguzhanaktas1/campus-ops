      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 py-14">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 gap-8 mb-12">
          ...
          <div className="col-span-2 sm:col-span-3 lg:col-span-1">
            <Link href="/" className="flex items-center gap-2.5 mb-4" aria-label="CampusOps home">
            ...
            <div className="flex items-center gap-3 mt-5">
              <a
                href="https://twitter.com/campusops"
                target="_blank"
                ...
                aria-label="CampusOps on Twitter/X"
              >
              ...
              <a
                href="https://linkedin.com/company/campusops"
                target="_blank"
                rel="noopener noreferrer"
                className="size-8 rounded-lg border border-border bg-card flex items-center justify-center text-muted-foreground hover:text-foreground hover:border-foreground/40 transition-colors"
                aria-label="CampusOps on LinkedIn"
              >
                <svg className="size-3.5" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
              ...
              <a
                href="https://github.com/campusops"
                target="_blank"
                rel="noopener noreferrer"
                className="size-8 rounded-lg border border-border bg-card flex items-center justify-center text-muted-foreground hover:text-foreground hover:border-foreground/40 transition-colors"
                aria-label="CampusOps on GitHub"
              >
                <svg className="size-3.5" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-between gap-3 pt-8 border-t border-border">
          <p className="text-xs text-muted-foreground">
            © {new Date().getFullYear()} CampusOps. All rights reserved.
          </p>
          ...
          <p className="text-xs text-muted-foreground">
            Made with care for higher education
          </p>
        </div>
      </div>
    </footer>
