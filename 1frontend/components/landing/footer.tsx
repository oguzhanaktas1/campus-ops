...
export function Footer() {
  ...
  return (
    <footer className="border-t border-border bg-muted/30" aria-label={t('footer.aria')}>
      <div className="max-w-6xl mx-auto px-4 sm:px-6 py-14">
        <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 gap-8 mb-12">
          <div className="col-span-2 sm:col-span-3 lg:col-span-1">
            <Link href="/" className="flex items-center gap-2.5 mb-4" aria-label={t('footer.homeAria')}>
            ...
            <div className="flex items-center gap-3 mt-5">
              <a
                href="https://twitter.com/campusflow"
                target="_blank"
                rel="noopener noreferrer"
                className="size-8 rounded-lg border border-border bg-card flex items-center justify-center text-muted-foreground hover:text-foreground hover:border-foreground/40 transition-colors"
              ...
              <a
                href="https://linkedin.com/company/campusflow"
                target="_blank"
                rel="noopener noreferrer"
                className="size-8 rounded-lg border border-border bg-card flex items-center justify-center text-muted-foreground hover:text-foreground hover:border-foreground/40 transition-colors"
              ...
              <a
                href="https://github.com/campusflow"
                target="_blank"
                rel="noopener noreferrer"
                className="size-8 rounded-lg border border-border bg-card flex items-center justify-center text-muted-foreground hover:text-foreground hover:border-foreground/40 transition-colors"
          ...
          {footerLinks.map(({ section, links }) => (
            <div key={section}>
              <h3 className="text-xs font-bold text-foreground uppercase tracking-widest mb-4">{section}</h3>
        ...
        <div className="flex flex-col sm:flex-row items-center justify-between gap-3 pt-8 border-t border-border">
          <p className="text-xs text-muted-foreground">
            &copy; {new Date().getFullYear()} <span>CampusFlow</span>. {t('footer.rights')}
          </p>
