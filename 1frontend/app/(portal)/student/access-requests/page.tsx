...
import { PlusCircle, ShieldCheck, Loader2, AlertCircle } from 'lucide-react'
  ...
  return (
    <div className="p-6 max-w-4xl mx-auto space-y-5 pb-20">
      <div className="flex items-start justify-between gap-4">
        <div>
          <h1 className="text-xl font-bold text-foreground">{t('pages.accessRequestsTitle')}</h1>
          <p className="text-sm text-muted-foreground mt-0.5">{t('pages.accessRequestsSubtitle')}</p>
        </div>
        <Link href="/student/access-requests/new" className="shrink-0">
