...
export default function NewStudentEquipmentPage() {
  ...
  const [form, setForm] = useState({
    ...
    equipmentName: '',       // manuel ad (resource seçilmezse)
  ...
  const handleResourceSelect = (resourceId: string) => {
    ...
    if (r) {
      ...
      // Resource adından kategori tahmin et
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      clearAttachmentCache('student-equipment-new')
  ...
  return (
    <div className="p-6 max-w-2xl mx-auto space-y-6 pb-20">
      ...
      <form onSubmit={handleSubmit} className="bg-card border border-border rounded-xl shadow-sm p-6 space-y-5">
        ...
        <div className="pt-2">
          <RequestAttachments onChange={setAttachments} uploadUrl={`${BACKEND}/student/upload`} storageKey="student-equipment-new" />
        </div>
