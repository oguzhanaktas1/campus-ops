...
import { MapPin, Loader2, Search, AlertCircle, ChevronLeft, ChevronRight } from 'lucide-react'
      ...
      <div className="bg-card border border-border rounded-lg shadow-sm overflow-hidden">
        {isLoading ? (
          ...
          <div className="flex flex-col items-center py-16 text-center">
            ...
            <p className="text-sm font-medium text-foreground">{t('reservations.noReservations')}</p>
          </div>
        ) : (
