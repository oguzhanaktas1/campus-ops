...
export default function FacultyEquipmentDetailPage() {
  ...
  if (!data) return (
    <div className="p-6 max-w-3xl mx-auto flex flex-col items-center py-16">
      ...
      <Link href="/faculty/equipment"><Button variant="outline" size="sm" className="mt-3">Back</Button></Link>
    </div>
  )
  ...
  return (
    <div className="p-6 space-y-5 max-w-3xl mx-auto pb-20">
      <Link href="/faculty/equipment"><Button variant="ghost" size="sm" className="gap-1.5"><ArrowLeft className="size-4" /> Back</Button></Link>
