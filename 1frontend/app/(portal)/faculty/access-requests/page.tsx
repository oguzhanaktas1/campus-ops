...
const PAGE_SIZE = 20
const ALL_STATUSES = ['SUBMITTED', 'IN_REVIEW', 'WAITING_APPROVAL', 'APPROVED', 'REJECTED', 'COMPLETED']
...
export default function FacultyAccessRequestsPage() {
  ...
  return (
    <StaffListShell
      ...
      subtitle={t('accessRequests.subtitle', { count: requests.length })}
      tabs={tabs}
      activeTab={filter}
      ...
      emptyTitle={t('accessRequests.noRequests')}
    ...
    >
      {paged.map((r) => (
        <StaffRequestRow
          ...
          title={r.title || t('accessRequests.title')}
