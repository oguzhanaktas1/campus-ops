...
from app.metrics import messages_processed, processing_time, documents_generated
...
async def process(message: AbstractIncomingMessage) -> None:
    async with message.process(requeue=False):
        ...
        try:
            ...
            await document_handler.handle(payload)
            ...
            logger.error("document_consumer_error", error=str(exc),
